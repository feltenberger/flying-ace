        ...
        <div className="px-6 py-5 space-y-6 text-sm text-military-300 leading-relaxed">
          ...
          <Section title="Shop Items">
            <div className="space-y-2">
              ...
              <Item name="Trade" cost="var" image={images.shopItemImages[ShopItemId.Trade]}>Propose a trade with another player. Offer and request any combination of fuel, planes, and items. The partner can accept or decline.</Item>
